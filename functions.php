...
//child pages shortcodeのcssのurlを変更
...
//検索ワードが未入力または０の場合にsearch.phpをテンプレートとして使用する
...
function the_pickup_excerpt() {
 ...
 remove_filter('excrpt_mblengh', 'pickup_excerpt_length', 11);
}
